...
\begin{itemize}
  \item Refer to the \textsc{Project4\_QuestionsTemplate} for information on Q6 of the Project 4 written questions. Please submit this file to Gradescope under the Project 4 Written Code (Numpy)	assignment along with your completed \texttt{main.py}
