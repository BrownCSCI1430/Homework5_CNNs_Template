...
\begin{itemize}
  ...
  \item 6 technical questions (Q5 and Q6 with code components).
...
\paragraph{Q1.1:} CNN interpretability remains an open question. In medical imaging, hand designing features with biological experts might lead to a generalizable and explainable method for physicians, regulators, or patients. However, deep learning methods can show \href{https://drive.google.com/file/d/1bDAqEtW482OJeqMBt5A4AradVa4gf_o9/view}{higher test accuracy}, even if their results may be less explainable. 

For your final project, you decide to create a CNN for medical imaging purposes. After extensive testing, you find that your CNN can detect a rare disease with 90\% accuracy. Existing technology is able to detect this disease with only 20\% accuracy. You have no medical background. (You are not a PLME). You cannot explain how your CNN accurately detects the disease, just that it does. 

How confident are you that your model should be used in a clinical setting and why? What are three factors that would make you more or less confident? If your model is deployed and an incorrect result causes a patient harm, who should be held responsible? [6-7 sentences]

\paragraph{A1.1:} Your answer here.
\pagebreak
\paragraph{Q1.2:} Please respond to this \href{https://docs.google.com/forms/d/e/1FAIpQLScJdjerPNCJu6kzMAhSgiUeturxoNUa3SdekSKJ-bc_Xutiiw/viewform?usp=sf_link}{multiple choice question} about the previous scenario. 

\paragraph{Q2:} There have been many attempts to make CNNs more interpretable:
\begin{itemize}
\item This assignment requires you to use LIME to attempt to explain your model predictions. 
\item James also mentioned \href{https://www.cs.cmu.edu/~aharley/vis/conv/}{this website} in class, which visualizes how a CNN works on the MNIST dataset.
...
To what extent would each of these methods make you more confident in your understanding of your medical imaging CNN and why? Outside of medical technology, when is being able to interpret the reasons a machine made a decision important and when is it not? [6-7 sentences]
...
\pagebreak
\paragraph{Q6:} Follow the \href{https://browncsci1430.github.io/webpage/resources/gcp_guide/}{GCP guide} to set up GCP. \emph{Note:} This is tricky, and it will take you some time to become familiar with the system! Once finished, complete one of these two Tensorflow MNIST tutorials on GCP:
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{A6:} Please insert a screenshot of the tutorial code output, running on GCP:
